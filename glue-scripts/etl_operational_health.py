...
# ==================================================
# 2. S3 PATHS (ONLY CHANGE)
# ==================================================
raw_path = f"s3://{args['RAW_BUCKET']}/raw/"
reference_path = f"s3://{args['RAW_BUCKET']}/reference/airlines/"
output_path = f"s3://{args['OUTPUT_BUCKET']}/gold/airline_airport_operational_health/"
...
# ==================================================
# 9. OPERATIONAL METRICS (UNCHANGED)
# ==================================================
final_df = (
    final_df
...
# ==================================================
# 10. WRITE GOLD (UNCHANGED STRUCTURE)
# ==================================================
final_df.write \
    .mode("overwrite") \
    .format("parquet") \
